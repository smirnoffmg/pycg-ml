...
from pycg_ml.machinery.callgraph import CallGraph
from pycg_ml.machinery.classes import ClassManager
...
from pycg_ml.processing.preprocessor import PreProcessor
...
class CallGraphGenerator:
    ...
    def _get_mod_name(self, entry, pkg):
        ...
        # since pycg_ml can't differentiate between functions
